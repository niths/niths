...
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(1, 1);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(2, 2);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(3, 3);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(4, 4);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(5, 5);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(6, 6);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(7, 7);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(8, 8);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(9, 9);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(10, 10);

insert into students_student_orientation_groups (students_id, orientationGroup_id) values(10, 11);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(22, 12);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(13, 13);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(44, 14);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(15, 15);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(36, 16);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(37, 17);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(48, 18);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(39, 19);
insert into students_student_orientation_groups (students_id, orientationGroup_id) values(32, 20);
