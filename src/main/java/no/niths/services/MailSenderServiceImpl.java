...
public class MailSenderServiceImpl implements MailSenderService {
	...
	public void sendDeveloperRegistratedConfirmation(Developer dev){
		...
		sendMimeMessage(prepare(dev.getEmail(), AdminConstantNames.NITHS_EMAIL, subject, EmailTexts.getDeveloperConfirmationBody(dev)));
	}
	...
	public void sendDeveloperAddedAppConfirmation(Developer dev, Application app){
		...
		sendMimeMessage(prepare(dev.getEmail(), AdminConstantNames.NITHS_EMAIL, subject, EmailTexts.getAddedAppToDevelioperBody(app)));
	}
	
	public void sendDeveloperEnabledConfirmation(Developer dev){
		String subject = "Hi " + dev.getName()+ ". Your are now enabled!";
		sendMimeMessage(prepare(dev.getEmail(), AdminConstantNames.NITHS_EMAIL, subject, EmailTexts.getDeveloperEnabledBody(dev)));
	}
	...
	public void sendApplicationEnabledConfirmation(Developer dev,
		...
		sendMimeMessage(prepare(dev.getEmail(), AdminConstantNames.NITHS_EMAIL, subject, EmailTexts.getApplicationEnabledBody(dev, app)));
	}
