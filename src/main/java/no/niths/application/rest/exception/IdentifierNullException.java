...
@ResponseStatus(value = HttpStatus.NO_CONTENT, reason = "The given object has a null identifier")
public class IdentifierNullException extends RuntimeException {
	...
	public IdentifierNullException(final String message, final Throwable cause) {
		super(message, cause);
	}
