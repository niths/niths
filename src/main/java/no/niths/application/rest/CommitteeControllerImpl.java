...
public class CommitteeControllerImpl
    ...
    @PreAuthorize(SecurityConstants.ADMIN_SR_COMMITTEE_LEADER)
    @RequestMapping(
            value ="add/leader/{committeeId}/{studentId}",
    ...
    @PreAuthorize(SecurityConstants.ADMIN_SR_COMMITTEE_LEADER)
    @RequestMapping(
            value = "remove/leader/{committeeId}/{studentId}",
            method = RequestMethod.PUT)
    ...
    @PreAuthorize(SecurityConstants.ADMIN_SR_COMMITTEE_LEADER)
    @RequestMapping(
            value = "add/event/{committeeId}/{eventId}",
            method = RequestMethod.PUT)
    ...
    @PreAuthorize(SecurityConstants.ADMIN_SR_COMMITTEE_LEADER)
    @RequestMapping(
            value = "remove/event/{committeeId}/{eventId}",
            method = RequestMethod.PUT)
