...
public class FadderGroupControllerImpl extends
	...
	public void addLeaderToAGroup(@PathVariable Long groupId,
	...
	public void removeLeaderFromAGroup(@PathVariable Long groupId,
			@PathVariable Long studId) {
		FadderGroup group = getGroup(groupId);
		Student stud = getStudent(studId);
	...
	public void addChildToAGroup(@PathVariable Long groupId,
			@PathVariable Long studId) {
		FadderGroup group = getGroup(groupId);
		Student stud = getStudent(studId);
	...
	public void removeChildFromGroup(@PathVariable Long groupId,
			@PathVariable Long studId) {
		FadderGroup group = getGroup(groupId);
		Student stud = getStudent(studId);
	...
	@Override
	@PreAuthorize(SecurityConstants.ADMIN_SR_FADDER_LEADER)
	@RequestMapping(value = { "{groupId}/remove-children/{studentIds}" }, method = RequestMethod.DELETE)
	@ResponseStatus(value = HttpStatus.OK, reason = "Children removed")
	public void removeChildrenFromGroup(@PathVariable Long groupId,
