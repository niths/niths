...
public abstract class AbstractRESTControllerImpl<T> implements
	...
	/**
	 * Returns an array list with all exams like getAll(domain), but also
	 * supports pagination
	 * <p>
	 * 
	 * @param domain
	 *            object with attributes to search for
	 * @param firstResult
	...
	@ResponseBody
	public ArrayList<T> getAll(T domain, @PathVariable int firstResult,
